program cylinder_scatter
    ...
    real :: r_square, r                                                                     ! r_square: 与圆心距离平方, R: 导体柱半径
    ...
    do n = 1, t_max
        ...
        do i = x_min, x_max
            do j = y_min, y_max-1
                r_square = (i**2+j**2)*dlt**2
                if ( r_square < R**2 ) then
    ...
    ! 计算结果输出
    ! do j = y_min, y_max
    !     write(20, '(321F15.5)') (Ezn(i, j), i = x_min, x_max)
    ! end do
